...
class SysStartSendRawData(CommandStructure):
    def __init__(self):
        ...
        self.type = None    
        self.motion_id = 0
        self.motion_sample_rate = 100
        self.motion_resolution = 16
        self.acc_range = 4
        self.gyr_range = 250
        self.ecg_sample_rate = 125
        self.ecg_adc_resolution = 12
        self.ecg_adc_vref = 1200
        self.ecg_amp_gain = 4551
        self.ecg_amp_offset = 1098
        self.signed = 1
        self.user_gender = 1
        self.user_height = 180
        self.user_weight = 70
        self.user_age = 25
    ...
    def attribute_parser(self, parameters, type_key):
        ...
        self.len = parameters.rsplit(b",", 1)[1]
